...
class Purchase extends Component {
    ...
    constructor(props) {
        ...
        this.handleSubmit = this.handlePurchaseSubmit.bind(this);
...
render() {
    ...
    return (
        <div className="purchase-Container">
            <Mui.Paper className="purchase-paper">

                <Mui.AppBar title="Add Purchase" showMenuIconButton={false} />
                <form onSubmit={this.handleSubmit} onChange={this.clearErrors}>
                    ...
                    <Mui.RaisedButton type="submit" label="Add Purchase" primary={true} className="purchase-loginBtn" />
